...
class UserApiTests(APITestCase):
    ...
    def test_get_invalid_token(self):
        ...
        with patch.object(UserApi, 'get_permissions', return_value=[]), \
             patch("task_manager_app.controllers.user_controllers.AC.get_user", return_value=None):
    ...
    def test_get_users_list_success(self):
        request = self.factory.get("/user/")
        with patch.object(UserApi, 'get_permissions', return_value=[]), \
             patch("task_manager_app.controllers.user_controllers.AC.get_user", return_value=self.dummy_user), \
    ...
    def test_delete_success(self):
        ...
        with patch.object(UserApi, 'get_permissions', return_value=[]), \
             patch("task_manager_app.controllers.user_controllers.AC.get_user", return_value=self.dummy_user), \
             patch("task_manager_app.controllers.user_controllers.UserComponents.get_user_by_id", return_value=self.dummy_user):
            # Patch the delete method on the dummy user.
